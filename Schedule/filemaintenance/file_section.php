                                ...
                                <div class="col-md-6">
                                    ...
                                    <select class="form-control" id="department" name="Department" required>
                                        ...
                                        <?php
                                            ...
                                            $sqlDepartment = "SELECT d.DepartmentID, d.GradeLevel, s.StrandID, s.StrandCode, dt.DepartmentName
                                                                FROM departments d
                                                                LEFT JOIN strands s ON d.StrandID = s.StrandID
                                                                LEFT JOIN departmenttypes dt ON d.DepartmentTypeNameID = dt.DepartmentTypeID 
                                                                WHERE dt.DepartmentName IN ('Primary', 'Junior High School', 'Senior High School')
                                            ...
                                            if ($resultDepartmentTypeName->num_rows > 0) {
                                                ...
                                                foreach ($seniorHighOptions as $strandCode => $options) {
                                                    echo '<optgroup label="' . $strandCode . '">' . implode("", $options) . '</optgroup>';
                                                }
                                                echo '</optgroup>';
                                            }
                                            ?>
    ...
    $(document).ready(function () {
        ...
        function validateFormFields() {
            ...
            fields.forEach(function(field) {
                ...
                if ((field.id === "sectionName") && !/^[a-zA-Z]*$/.test(trimmedValue)) {
                    showValidationMessage(field, 'Only letters are allowed.');
                } else if ((field.id === "sectionName") && !trimmedValue) {
