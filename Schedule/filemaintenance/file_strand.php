    ...
    $(document).ready(function () {
        ...
        function validateFormFields() {
            ...
            fields.forEach(function(field) {
                ...
                if ((field.id === "sName" || field.id === "trackType"  || field.id === "spec") && !/^[a-zA-Z]*$/.test(trimmedValue)) {
                    showValidationMessage(field, 'Only letters are allowed.');
                // } else if ((field.id === "sName" || field.id === "trackType"  || field.id === "spec") && !trimmedValue) {
                //     showValidationMessage(field, 'This field cannot be empty.');
                } else if (field.id === "stCode") {
                ...
                } else if (field.id !== "stCode" && /^\s/.test(field.value)) {
                    showValidationMessage(field, 'Spaces before letters are not allowed.');
                }  else {
                    hideValidationMessage(field);
                }
