                                ...
                                <div class="card mb-3">
                                    ...
                                    <div class="form-group d-flex align-items-center">
                                        ...
                                        <div>
                                            ...
                                            <button class='btn btn-danger trash-btn' title='Trash' data-user-id='<?php echo $secdata['InstructorSpecializationsID']; ?>'>
                                                <i class='fas fa-trash'></i>
                                            </button>
...
$(document).ready(function() {
    ...
    function validateFormFields() {
        ...
        fields.forEach(function(field) {
            var trimmedValue = field.value.trim();
            if ((field.id === "specialization") && !/^[a-zA-Z]*$/.test(trimmedValue)) {
                showValidationMessage(field, 'Only letters are allowed.');
